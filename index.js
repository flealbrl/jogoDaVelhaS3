...
const nomes = () => {
    ...
    console.log(`${player1} joga com X`);
    console.log(`${player2} joga com O`);
...
jogo: while (true) {
    ...
    console.log();
    let jogadaPlayer1 = +prompt(`${jogadores[0]} faça sua jogada: `);
    while (
        ...
        if (escolhas.indexOf(jogadaPlayer1) != -1) {
            console.log('Posição já prenchida.');
        } else {
            console.log('Posição invalida.');
        }
        jogadaPlayer1 = +prompt(`${jogadores[0]} faça sua jogada: `);
    }
    ...
    let jogadaPlayer2 = +prompt(`${jogadores[1]} faça sua jogada: `);
    while (
        ...
        jogadaPlayer2 = +prompt(`${jogadores[1]} Quer jogar novamente? `);
    }
